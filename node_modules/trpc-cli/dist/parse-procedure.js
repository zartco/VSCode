...
export function getProcedureInputJsonSchemas(inputs, dependencies) {
    ...
    const schemas = converted.map(c => c.value);
    return { success: true, value: schemas };
}
export function parseJsonSchemaInputs(schemas) {
...
function parseProcedureInputsInner(schemasResult) {
...
function parseMultiInputs(schemas) {
