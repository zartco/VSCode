  ...
  return (
    <div className="create-subagent">
      ...
      <form onSubmit={handleSubmit} className="subagent-form">
        <label>
          Name:
          <input value={name} onChange={e => setName(e.target.value)} required placeholder="e.g., translator" />
        </label>
        <label>
          Vendor:
        ...
        <label>
          Triggers:
          <input value={triggers} onChange={e => setTriggers(e.target.value)} required placeholder="e.g., translate, перевод" />
        </label>
        <label>
          Instructions:
          <textarea value={instructions} onChange={e => setInstructions(e.target.value)} required placeholder="You are a professional translator..." rows={10} />
        </label>
