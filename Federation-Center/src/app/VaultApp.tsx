...
import AgentDashboard from "@/components/federation/AgentDashboard";
...
export default function VaultApp({ files, folders }: VaultAppProps) {
  ...
  const [activeView, setActiveView] = useState<
    "federation" | "folder" | "file" | "analytics" | "timelapse" | "3dnexus" | "agent_dashboard"
  >("3dnexus");
        ...
        >
          ...
          >
            ...
            <div className="sidebar-nav">
              ...
              <div
                className={`folder-item ${activeView === "agent_dashboard" ? "active" : ""}`}
                onClick={() => {
                  setActiveFolder(null);
                  setActiveFile(null);
