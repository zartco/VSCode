    ...
    >
      ...
      >
        ...
        >
          ...
          />
          <h2 style={{ margin: 0, fontSize: "14px", letterSpacing: "1px", color: "#ff00ff" }}>
      ...
      <div style={{ padding: "16px", borderBottom: "1px solid #333" }}>
        ...
        >
          ...
          <span style={{ color: "#ffff00" }}>{agents.length}</span>
        </div>
      </div>
      ...
      >
        {agents.length > 0 && (
          <div>
            <h3
              style={{ fontSize: "12px", color: "#00ffff", marginBottom: "12px" }}
            >
              AGENTS
            </h3>
            <div
            ...
            >
              {agents.map((agent, i) => (
                ...
                >
                  ...
                  >
                    <strong style={{ color: "#ff00ff", fontSize: "12px" }}>
                    ...
                    <span
                      style={{
                        fontSize: "10px",
                        color:
                          agent.status === "active" ? "#00ffff" : "#ffaa00",
                      }}
                    >
                      {agent.status || "idle"}
                    </span>
