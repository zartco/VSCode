...
> **Note:** The definitive, interactive documentation and agent handoff payloads are managed within a local **Obsidian Vault** (`C:\VSCode\Vault`). This README provides a high-level overview for GitHub.
